...
Senha da rede: $senha_da_rede
Assim que reiniciar o raspberry, as configurações entrarão em funcionamento."
echo "Assim que reiniciar o comando para entrar via ssh é:
ssh user@192.168.1.2
user sendo o nome do seu usuario."